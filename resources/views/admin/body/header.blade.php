<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img
                            src="{{
                                asset('backend/assets/images/flags/germany.jpg')
                            }}"
                            alt="user-image"
                            class="me-1"
                            height="12"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img
                            src="{{
                                asset('backend/assets/images/flags/italy.jpg')
                            }}"
                            alt="user-image"
                            class="me-1"
                            height="12"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img
                            src="{{
                                asset('backend/assets/images/flags/spain.jpg')
                            }}"
                            alt="user-image"
                            class="me-1"
                            height="12"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img
                            src="{{
                                asset('backend/assets/images/flags/russia.jpg')
                            }}"
                            alt="user-image"
                            class="me-1"
                            height="12"
            ...
            @php $id = Auth::user()->id; $adminData =
            App\Models\User::find($id); @endphp
            <li class="dropdown notification-list topbar-dropdown">
                <a
