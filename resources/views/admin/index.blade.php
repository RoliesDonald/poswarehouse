            ...
            <div class="col-xl-4 col-md-8">
                <div class="card">
                    <div class="card-body pb-2">
                        ...
                        <h4 class="header-title mb-0">Your Works</h4>
                            ...
                            <div class="text-center pt-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col-4">
                                        ...
                                        <h4>
                                            <i class="fe-arrow-down text-danger me-1"></i>18k
                                        </h4>
                                    </div>
                                    <div class="col-4">
                                        <p class="text-muted font-15 mb-1 text-truncate">
                                        ...
                                        <h4>
                                            <i class="fe-arrow-up text-success me-1"></i>3.25k
                                        </h4>
                                    </div>
                                    <div class="col-4">
                                        <p class="text-muted font-15 mb-1 text-truncate">
                                        ...
                                        <h4>
                                            <i class="fe-arrow-up text-success me-1"></i>28k
                                        </h4>
                                    </div>
                                </div>
                                <!-- end row -->
