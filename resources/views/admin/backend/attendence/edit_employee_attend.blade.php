                            ...
                            <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" style="vertical-align: middle">Img.</th>
                                    ...
                                    <tr>
                                        <th class="text-center text-white btn present_all"
                                            style="display: table-cell;background-color:#01a846">Present</th>
                                        <th class="text-center text-white btn leave_all"
                                            style="display: table-cell;background-color:#01a846">Leave</th>
                                        <th class="text-center text-white btn absent_all"
                                            style="display: table-cell;background-color:#01a846">Absent</th>
                                    </tr>
                                </thead>
                                <tbody>
