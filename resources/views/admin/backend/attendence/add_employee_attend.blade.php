                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <h4>
                                <a href="  " class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>
                        ...
                        <form action=" " method="post" id="myForm">
                            ...
                            <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="text-center text-white btn present_all"
                                            style="display: table-cell;background-color:#0804e1">Present</th>
                                        <th class="text-center text-white btn leave_all"
                                            style="display: table-cell;background-color:#e9c707">Leave</th>
                                        <th class="text-center text-white btn absent_all"
                                            style="display: table-cell;background-color:#dd0404">Absent</th>
                                    </tr>
                                </thead>
                                <tbody>
