                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('all.product') }}"
                                    class="btn btn-warning rounded-pill waves-effect waves-light">Back</a>
                            </li>
                        </ol>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <h3>{!!
                                            $generator->getBarcode($barProduct->product_code,$generator::TYPE_CODE_128)
                                            !!}</h3>
                                    </div>
                                </div>
                                <!-- end col -->
